...
# while True:
#     alegere1 = input("Alege p, h, f,: ")
#     alegere2 = random.choice(["p", "h", "f"])
#     print(nume, "a ales :", alegere1)
#     print("Calculatorul a ales : ", alegere2)
#     if alegere1 == "p" and alegere2 == "h":
#         print("Calculatorul a castigat")
#     elif alegere1 == "h" and alegere2 == "f":
#         print("Calculatorul a castigat")
#     elif alegere1 == "f" and alegere2 == "p":
#         print("Calculatorul a castigat")
#     elif alegere1 == alegere2:
#         print("Egalitate")
#     else:
